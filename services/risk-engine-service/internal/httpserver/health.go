...
// stack as scheduler-service — request logging + panic recovery feed the
// same structured log used for troubleshooting the pipeline.
package httpserver
